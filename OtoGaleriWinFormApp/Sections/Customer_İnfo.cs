...
namespace OtoGaleriWinFormApp
{
    public partial class Customer_İnfo : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            label9.Text = "Search:";
            label9.Location = new Point(532, 247);
        ...
        {
            label9.Location = new Point(505, 246);
            label9.Text = "Searching...";
            string search = search_richtexbox.Text;
            var value = from x in db.Customer
                        ...
                        select x;
            customer_datagridview.DataSource = value.ToList();

            //customer_datagridview.Columns[8].Visible = false;
            //customer_datagridview.Columns[9].Visible = false;
